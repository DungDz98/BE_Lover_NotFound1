...
public class User {
    ...
    public User(Long id, String userName, String password, String email, String phoneNumber, String name, Date dateOfBirth, String gender, String city, String nationality, String avatar, String height, String weight, String hobby, String description, String requestToPayer, String linkFb, Date createAt, Date createAtCCDV, int statusCCDV, int statusUs, double price, Set<Role> roles) {
        this.id = id;
