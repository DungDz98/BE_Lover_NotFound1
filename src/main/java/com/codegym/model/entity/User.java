...
public class User {
    ...
    //0: chưa đang kí CCDV, 1: chờ admin duyệt CCDV; 2: trờ thành CCDV, 3: trạng thái tạm ngưng
    private int statusCCDV;

    //0: Chờ phê duyệt, 1: Đăng ký thành công, 2: Bị admin block, 3: Set Vip
